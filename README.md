...
# Senior Capstone Assignment: Implementing Reinforcement Learning Agents with Gym​nasium

This repository contains the code for implementing a Q-Learning agent for the Mountain Car environment in Gymanisum.

## Sources
### Hands-On Intelligent Agents with OpenAI Gym by Praveen Palanisamy
This textbook was closely followed along with for the Mountain Car implementation.
